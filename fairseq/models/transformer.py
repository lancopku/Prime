...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--bm_in_a', type=float, default=3, help='sqrt(6/(1+a)),-1 for xavier')
        parser.add_argument('--bm_out_a', type=float, default=0, help='sqrt(6/(1+a)), -1 for xavier')
