...
class LightConvModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        # sample based net
        parser.add_argument('--sample_lc', type=int, default=0)
        parser.add_argument('--sample_lc_sp', type=int, default=0, help='same parameters')
        parser.add_argument('--unsample_dc', type=int, default=0)
...
class LightConvDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False, final_norm=True):
        ...
        self.project_in_dim = Linear(in_features=input_embed_dim, out_features=embed_dim, layer_id=0, args=args, bias=False) if embed_dim != input_embed_dim else None
        ...
        self.project_out_dim = Linear(in_features=embed_dim, out_features=output_embed_dim,layer_id=args.decoder_layers-1, args=args, bias=False) \
    ...
    def __init__(self, args, kernel_size=0):
        ...
        if args.encoder_conv_type == 'lightweight':
            self.conv = LightweightConv1dTBC(self.conv_dim, kernel_size, padding_l=padding_l,
                                             ...
                                             weight_dropout=args.weight_dropout, args=args,cur_attn_type='es')
        elif args.encoder_conv_type == 'dynamic':
            self.conv = DynamicConv1dTBC(self.conv_dim, kernel_size=kernel_size, padding_l=padding_l,
                                         weight_softmax=args.weight_softmax,
                                         num_heads=args.encoder_attention_heads,
                                         weight_dropout=args.weight_dropout, args=args)
        else:
        ...
        self.fc1 = Linear(self.embed_dim, args.encoder_ffn_embed_dim, args=args)
        self.fc2 = Linear(args.encoder_ffn_embed_dim, self.embed_dim, args=args)
        self.layer_norms = nn.ModuleList([LayerNorm(self.embed_dim, args=args) for _ in range(2)])
    ...
    def __init__(self, args, no_encoder_attn=False, kernel_size=0):
        ...
        if args.decoder_conv_type == 'lightweight':
            self.conv = LightweightConv1dTBC(self.conv_dim, kernel_size, padding_l=kernel_size-1,
                                             ...
                                             weight_dropout=args.weight_dropout, args=args, cur_attn_type='ds')
        elif args.decoder_conv_type == 'dynamic':
            self.conv = DynamicConv1dTBC(self.conv_dim, kernel_size=kernel_size, padding_l=kernel_size-1,
                                         weight_softmax=args.weight_softmax,
                                         num_heads=args.decoder_attention_heads,
                                         weight_dropout=args.weight_dropout, args=args)
        else:
        ...
        self.fc1 = Linear(self.embed_dim, args.decoder_ffn_embed_dim,args=args,)
        self.fc2 = Linear(args.decoder_ffn_embed_dim, self.embed_dim,args=args,)
