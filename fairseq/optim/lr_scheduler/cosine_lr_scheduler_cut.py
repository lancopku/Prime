...
@register_lr_scheduler('cosine_cut')
class CosineCutSchedule(FairseqLRScheduler):
    ...
    def __init__(self, args, optimizer):
        ...
        self.cut_lr = self.args.lr_cut * self.max_lr
    ...
    def add_args(parser):
        ...
        parser.add_argument('--lr_cut', default=0.7, type=float,
