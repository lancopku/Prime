...
class FairseqAdaMod(FairseqOptimizer):
    def __init__(self, args, params):
        super().__init__(args, params)
        self._optimizer = AdaMod(params, lr=args.lr[0], gamma=args.gamma)

    @staticmethod
    def add_args(parser):
        """Add optimizer-specific arguments to the parser."""
        # fmt: off
        parser.add_argument('--gamma', default=0.9999,
                            help='')
...
class AdaMod(torch.optim.Optimizer):
